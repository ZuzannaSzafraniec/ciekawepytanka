...
<script>
    function z5()
    {
        document.getElementById("z5").innerHTML="Prezydent.";
    }
    function z6()
    {
...
<script>
    function z7()
    {
        document.getElementById("z7").innerHTML="Mył okna na pierwszym piętrze i stamtąd spadł.";
    }
    function z8()
    {
...
<script>
    function z9()
    {
        document.getElementById("z9").innerHTML="Do żadnego. Przecież nie ma takiej granicy!";
    }
    function z10()
    {
